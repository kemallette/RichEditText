...
public class OpacityBar	extends
						View{
	...
	private void init(AttributeSet attrs, int defStyle){
		...
		mBarPointerPosition = mBarLength
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh){
		...
		if (!isInEditMode())
			shader = new LinearGradient(mBarPointerHaloRadius,
										...
										mBarThickness,
										new int[] {
															Color.HSVToColor(	0x00,
																				mHSVColor),
															Color.HSVToColor(	0xFF,
																				mHSVColor) },
										null,
